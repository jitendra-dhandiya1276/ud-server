...
router.post('/verify-email', (0, validate_middleware_1.validate)(auth_validators_1.verifyEmailSchema), auth_controller_1.authController.verifyEmail.bind(auth_controller_1.authController));
router.post('/resend-verification', (0, validate_middleware_1.validate)(auth_validators_1.resendVerificationSchema), auth_controller_1.authController.resendVerification.bind(auth_controller_1.authController));
